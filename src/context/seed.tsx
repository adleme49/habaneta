// LEGACY SOURCE OF TRUTH for the built-in tile catalog.
//
// This file is NOT imported by the runtime — see src/lib/library.ts
// and public/library.json for the runtime catalog. It's kept only as
// the hand-curated source that `npm run generate-library` reads to
// (re)produce public/library.json. If you want to add or edit tiles,
// prefer editing public/library.json directly (or, eventually, the
// library admin UI) and only touch this file if you specifically want
// to regenerate from the original shape.
